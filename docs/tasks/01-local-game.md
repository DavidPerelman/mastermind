...
After Phase 1 is working locally, deploy to GitHub Pages:

1. Push all files to a GitHub repository (root folder)
2. Go to repo Settings → Pages → Source: `main` branch, `/ (root)`
3. GitHub will provide a public URL (e.g. `https://username.github.io/mastermind`)
4. No build step needed — pure HTML/CSS/JS
